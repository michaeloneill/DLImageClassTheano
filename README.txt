...
create a virtual envoronment with the DLImageClassTheano folder (http://docs.python-guide.org/en/latest/dev/virtualenvs/)
...
STEP 2) Create a new directory DLImageClassTheano/common/datasets/sat4-sat6/ and store sat-4-full.mat in there

STEP 3)

FOR TESTING THE CNN:

Navigate to DLImageClassTheano/common and run:
python generate_datasets.py
This will create a file DLImageClassTheano/common/datasets/sat4-sat6/sat4_scaled_rastered.npz which holds the data in sat-4-full.mat in a suitable format for our CNN algorithm
...
This will create a file DLImageClassTheano/common/datasets/sat4-sat6/sat4_scaled_unrolled.npz which holds the data in sat-4-full.mat in a suitable format for our MLP, SDA and DBN algorithms
This will take 5-10mins
...
STEP 5) Navigate to either the cnn, MLP, sdA or dbn directory in the DLImageClassTheano root directory, depending on which model you want to run.

STEP 7) Create a results directory to hold the output files that will be generated by running the models e.g. DLImageClassTheano/cnn/results/
